...
function ub(a,b){a.f?p(void 0)?b.call(void 0):b():(a.K||(a.K=[]),a.K.push(p(void 0)?w(b,void 0):b))}
...
L.prototype.G=function(a){this.b=0;ud(this,2,a)};
L.prototype.K=function(a){this.b=0;ud(this,3,a)};
function ud(a,b,c){if(0==a.b){a===c&&(b=3,c=new TypeError("Promise cannot resolve to itself"));a.b=1;var d;a:{var e=c,f=a.G,g=a.K;if(e instanceof L)Fd(e,xd(f||t,g||null,a)),d=!0;else{var k;if(e)try{k=!!e.$goog_Thenable}catch(m){k=!1}else k=!1;if(k)e.then(f,g,a),d=!0;else{if(pa(e))try{var h=e.then;if(oa(h)){Hd(e,h,f,g,a);d=!0;break a}}catch(m){g.call(a,m);d=!0;break a}d=!1}}}d||(a.D=c,a.b=b,a.g=null,Gd(a),3!=b||c instanceof Bd||Id(a,c))}}
function Hd(a,b,c,d,e){function f(a){k||(k=!0,d.call(e,a))}
function g(a){k||(k=!0,c.call(e,a))}
var k=!1;try{b.call(a,g,f)}catch(h){f(h)}}
function Gd(a){a.w||(a.w=!0,Kc(a.J,a))}
function Dd(a){var b=null;a.f&&(b=a.f,a.f=b.next,b.next=null);a.f||(a.i=null);return b}
L.prototype.J=function(){for(var a;a=Dd(this);)Ed(this,a,this.b,this.D);this.w=!1};
...
y(Bd,za);Bd.prototype.name="cancel";function M(a){D.call(this);this.j=1;this.g=[];this.i=0;this.b=[];this.H={};this.w=!!a}
y(M,D);l=M.prototype;l.subscribe=function(a,b,c){var d=this.H[a];d||(d=this.H[a]=[]);var e=this.j;this.b[e]=a;this.b[e+1]=b;this.b[e+2]=c;this.j=e+3;d.push(e);return e};
l.unsubscribe=function(a,b,c){if(a=this.H[a]){var d=this.b;if(a=Db(a,function(a){return d[a+1]==b&&d[a+2]==c}))return this.S(a)}return!1};
l.S=function(a){var b=this.b[a];if(b){var c=this.H[b];0!=this.i?(this.g.push(a),this.b[a+1]=t):(c&&Fb(c,a),delete this.b[a],delete this.b[a+1],delete this.b[a+2])}return!!b};
...
l.clear=function(a){if(a){var b=this.H[a];b&&(G(b,this.S,this),delete this.H[a])}else this.b.length=0,this.H={}};
l.ba=function(a){if(a){var b=this.H[a];return b?b.length:0}a=0;for(b in this.H)a+=this.ba(b);return a};
l.A=function(){M.B.A.call(this);this.clear();this.g.length=0};var Nd={},Od=0;function Pd(a){var b=new Image,c=""+Od++;Nd[c]=b;b.onload=b.onerror=function(){delete Nd[c]};
b.src=a}
;var Qd=r("yt.pubsub.instance_")||new M;M.prototype.subscribe=M.prototype.subscribe;M.prototype.unsubscribeByKey=M.prototype.S;M.prototype.publish=M.prototype.M;M.prototype.clear=M.prototype.clear;q("yt.pubsub.instance_",Qd,void 0);var Rd=r("yt.pubsub.subscribedKeys_")||{};q("yt.pubsub.subscribedKeys_",Rd,void 0);var Sd=r("yt.pubsub.topicToKeys_")||{};q("yt.pubsub.topicToKeys_",Sd,void 0);var Td=r("yt.pubsub.isSynchronous_")||{};q("yt.pubsub.isSynchronous_",Td,void 0);
...
b.P&&0<b.timeout&&(h=B(function(){k||(k=!0,m.abort(),jb(h),b.P.call(b.context||n,m))},b.timeout))}
...
a.P=function(){c(new ze("Request timed out","net.timeout"))};
...
Zf.prototype.g=function(a,b,c){var d,e=!1;0<c.timeout&&(d=B(function(){e||(e=!0,c.P&&c.P())},c.timeout));
...
sg.prototype.g=function(a,b,c){var d,e=!1;0<c.timeout&&(d=B(function(){e||(e=!0,c.P&&c.P())},c.timeout));
...
;var Kg=[],Lg=!1;function Mg(){function a(){Lg=!0;"google_ad_status"in window?z("DCLKSTAT",1):z("DCLKSTAT",2)}
...
;var Og=x().toString();function Pg(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=A("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){var d=a,e=A("VALID_SESSION_TEMPDATA_DOMAINS",[]),f=Qb(H(window.location.href)[3]||null);f&&e.push(f);f=Qb(H(d)[3]||null);if(Eb(e,f)||!f&&0==d.lastIndexOf("/",0)){Ve("autoescape_tempdata_url")&&(e=document.createElement("a"),Rc(e,d),d=e.href);var f=H(d),d=f[5],e=f[6],f=f[7],g="";d&&(g+=d);e&&(g+="?"+e);f&&(g+="#"+f);d=g;e=d.indexOf("#");if(d=0>e?d:d.substr(0,e))Ve("enable_more_related_ve_logging")&&
(b.itct||b.ved)&&(b.csn=b.csn||Ig()),d="ST-"+eb(d).toString(36),e=b?Vb(b):"",Pa.set(""+d,e,5,"/","youtube.com"),b&&(b=b.itct||b.ved,d=r("yt.logging.screen.storeParentElement"),b&&d&&d(new Re(b)))}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var k,h;k=void 0===k?{}:k;h=void 0===h?"":h;c=window.location;a=Rb(Ub([a],k))+h;a=a instanceof Xb?a:ac(a);c.href=Zb(a)}return!0}
...
y(Yg,D);Yg.prototype.subscribe=function(a,b,c){return this.f?0:this.b.subscribe(a,b,c)};
Yg.prototype.unsubscribe=function(a,b,c){return this.f?!1:this.b.unsubscribe(a,b,c)};
Yg.prototype.S=function(a){return this.f?!1:this.b.S(a)};
Yg.prototype.M=function(a,b){return this.f?!1:this.b.M.apply(this.b,arguments)};function Zg(a,b,c,d){this.top=a;this.right=b;this.bottom=c;this.left=d}
...
;var kh;var lh=E,lh=lh.toLowerCase();if(-1!=lh.indexOf("android")){var mh=lh.match(/android\D*(\d\.\d)[^\;|\)]*[\;\)]/);if(mh)kh=Number(mh[1]);else{var nh={cupcake:1.5,donut:1.6,eclair:2,froyo:2.2,gingerbread:2.3,honeycomb:3,"ice cream sandwich":4,jellybean:4.1},oh=[],ph=0,qh;for(qh in nh)oh[ph++]=qh;var rh=lh.match("("+oh.join("|")+")");kh=rh?nh[rh[0]]:0}}else kh=void 0;var sh=E,th=sh.match(/\((BB10|PlayBook|BlackBerry);/);!th||2>th.length||sh.match(/Version\/(\d+\.\d+)/);E.match(/Mozilla\/[\d\.]+ \(Mobile;.* rv:([\d\.]+)\) Gecko\/[\d\.]+ Firefox\/[\d\.]+/);var uh;var vh=E,wh=vh.match(/\((iPad|iPhone|iPod)( Simulator)?;/);if(!wh||2>wh.length)uh=void 0;else{var xh=vh.match(/\((iPad|iPhone|iPod)( Simulator)?; (U; )?CPU (iPhone )?OS (\d+_\d)[_ ]/);uh=xh&&6==xh.length?Number(xh[5].replace("_",".")):0}0<=uh&&0<=E.search("Safari")&&E.search("Version");var yh=['video/mp4; codecs="avc1.42001E, mp4a.40.2"','video/webm; codecs="vp8.0, vorbis"'],zh=['audio/mp4; codecs="mp4a.40.2"'];J&&K("9");!uc||K("528");tc&&K("1.9b")||J&&K("8")||rc&&K("9.5")||uc&&K("528");tc&&!K("8")||J&&K("9");function Ah(a){D.call(this);this.b=[];this.g=a||this}
y(Ah,D);function Bh(a,b,c,d){d=ib(w(d,a.g));d={target:b,name:c,qa:d};b.addEventListener(c,d.qa,void 0);a.b.push(d)}
function Ch(a){for(;a.b.length;){var b=a.b.pop();b.target.removeEventListener(b.name,b.qa)}}
Ah.prototype.A=function(){Ch(this);Ah.B.A.call(this)};function R(a,b){this.version=a;this.args=b}
function Dh(a){if(!a.Wa){var b={};a.call(b);a.Wa=b.version}return a.Wa}
function Eh(a,b){function c(){a.apply(this,b.args)}
if(!b.args||!b.version)throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete.");var d;try{d=Dh(a)}catch(e){}if(!d||b.version!=d)throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible.");c.prototype=a.prototype;try{return new c}catch(e){throw e.message="yt.pubsub2.Data.deserialize(): "+e.message,e;}}
function S(a,b){this.topic=a;this.b=b}
S.prototype.toString=function(){return this.topic};var Fh=window.performance||window.mozPerformance||window.msPerformance||window.webkitPerformance||{};function Gh(a){R.call(this,1,arguments)}
y(Gh,R);var Hh=new S("timing-sent",Gh);var Ih=r("yt.pubsub2.instance_")||new M;M.prototype.subscribe=M.prototype.subscribe;M.prototype.unsubscribeByKey=M.prototype.S;M.prototype.publish=M.prototype.M;M.prototype.clear=M.prototype.clear;q("yt.pubsub2.instance_",Ih,void 0);var Jh=r("yt.pubsub2.subscribedKeys_")||{};q("yt.pubsub2.subscribedKeys_",Jh,void 0);var Kh=r("yt.pubsub2.topicToKeys_")||{};q("yt.pubsub2.topicToKeys_",Kh,void 0);var Lh=r("yt.pubsub2.isAsync_")||{};q("yt.pubsub2.isAsync_",Lh,void 0);q("yt.pubsub2.skipSubKey_",null,void 0);
function T(a,b){var c=Mh();c&&c.publish.call(c,a.toString(),a,b)}
function U(a,b,c){var d=Mh();if(!d)return 0;var e=d.subscribe(a.toString(),function(d,g){if(!window.yt.pubsub2.skipSubKey_||window.yt.pubsub2.skipSubKey_!=e){var f=function(){if(Jh[e])try{if(g&&a instanceof S&&a!=d)try{g=Eh(a.b,g)}catch(h){throw h.message="yt.pubsub2 cross-binary conversion error for "+a.toString()+": "+h.message,h;}b.call(c||window,g)}catch(h){kb(h)}};
Lh[a.toString()]?r("yt.scheduler.instance")?Jg(f,void 0):B(f,0):f()}});
Jh[e]=!0;Kh[a.toString()]||(Kh[a.toString()]=[]);Kh[a.toString()].push(e);return e}
function Nh(a){var b=Mh();b&&("number"==typeof a&&(a=[a]),G(a,function(a){b.unsubscribeByKey(a);delete Jh[a]}))}
function Mh(){return r("yt.pubsub2.instance_")}
;function Oh(a,b,c){D.call(this);this.b=a;this.j=b||0;this.g=c;this.i=w(this.nb,this)}
y(Oh,D);l=Oh.prototype;l.ca=0;l.A=function(){Oh.B.A.call(this);this.stop();delete this.b;delete this.g};
l.start=function(a){this.stop();var b=this.i;a=p(a)?a:this.j;if(!oa(b))if(b&&"function"==typeof b.handleEvent)b=w(b.handleEvent,b);else throw Error("Invalid listener argument");this.ca=2147483647<Number(a)?-1:n.setTimeout(b,a||0)};
l.stop=function(){this.isActive()&&n.clearTimeout(this.ca);this.ca=0};
l.isActive=function(){return 0!=this.ca};
l.nb=function(){this.ca=0;this.b&&this.b.call(this.g)};var Ph={vc:!0},Qh={ad_at:"adType",cpn:"clientPlaybackNonce",csn:"clientScreenNonce",yt_lt:"loadType",yt_ad:"isMonetized",yt_ad_pr:"prerollAllowed",yt_red:"isRedSubscriber",yt_vis:"isVisible"},Rh=["isMonetized","prerollAllowed","isRedSubscriber","isVisible"],Sh=w(Fh.clearResourceTimings||Fh.webkitClearResourceTimings||Fh.mozClearResourceTimings||Fh.msClearResourceTimings||Fh.oClearResourceTimings||t,Fh);
function Th(a,b){if(!b&&"_"!=a[0]){var c=a;Fh.mark&&(0==c.lastIndexOf("mark_",0)||(c="mark_"+c),Fh.mark(c))}var c=Uh(),d=b||lb();c[a]&&(c["_"+a]=c["_"+a]||[c[a]],c["_"+a].push(d));c[a]=d;(Vh()["tick_"+a]=b)||lb();Ve("csi_on_gel")?(c=Wh(),"_start"==a?rg("latencyActionBaselined",{clientActionNonce:c},b):rg("latencyActionTicked",{tickName:a,clientActionNonce:c},b),c=!0):c=!1;if(c=!c)c=!r("yt.timing.pingSent_");if(c&&(d=A("TIMING_ACTION",void 0),c=Uh(),r("yt.timing.ready_")&&d&&c._start&&Xh())){var d=
!0,e=A("TIMING_WAIT",[]);if(e.length)for(var f=0,g=e.length;f<g;++f)if(!(e[f]in c)){d=!1;break}d&&Yh()}}
function Zh(){var a=$h().info.yt_lt="hot_bg";Vh().info_yt_lt=a;if(Ve("csi_on_gel"))if("yt_lt"in Qh){var b={},c=Qh.yt_lt;Eb(Rh,c)&&(a=!!a);b[c]=a;a=Wh();b.clientActionNonce=a;rg("latencyActionInfo",b)}else kb(Error("Unknown label yt_lt logged with GEL CSI."))}
function Xh(){var a=Uh();if(a.aft)return a.aft;for(var b=A("TIMING_AFT_KEYS",["ol"]),c=b.length,d=0;d<c;d++){var e=a[b[d]];if(e)return e}return NaN}
function Yh(){if(!Ve("csi_on_gel")){var a=Uh(),b=$h().info,c=a._start,d;for(d in a)if(0==d.lastIndexOf("_",0)&&ma(a[d])){var e=d.slice(1);if(e in Ph){var f=Bb(a[d],function(a){return Math.round(a-c)});
b["all_"+e]=f.join()}delete a[d]}e=!!b.ap;if(f=r("yt.timing.reportbuilder_")){if(f=f(a,b,void 0))ai(f,e),bi(),Sh(),ci(!1,void 0),z("PREVIOUS_ACTION",A("TIMING_ACTION")),z("TIMING_ACTION","")}else{var g=A("CSI_SERVICE_NAME","youtube"),f={v:2,s:g,action:A("TIMING_ACTION",void 0)},k=b.srt;delete b.srt;void 0===a.srt&&(k||0===k||(k=Fh.timing||{},k=Math.max(0,k.responseStart-k.navigationStart),isNaN(k)&&b.pt&&(k=b.pt)),k||0===k)&&(b.srt=Math.round(k));if(b.h5jse){var h=window.location.protocol+r("ytplayer.config.assets.js");
(h=Fh.getEntriesByName?Fh.getEntriesByName(h)[0]:null)?b.h5jse=Math.round(b.h5jse-h.responseEnd):delete b.h5jse}a.aft=Xh();di()&&"youtube"==g&&(Zh(),g=a.vc,h=a.pbs,delete a.aft,b.aft=Math.round(h-g));for(var m in b)"_"!=m.charAt(0)&&(f[m]=b[m]);a.ps=lb();b={};m=[];for(d in a)"_"!=d.charAt(0)&&(g=Math.round(a[d]-c),b[d]=g,m.push(d+"."+g));f.rt=m.join(",");(a=r("ytdebug.logTiming"))&&a(f,b);ai(f,e,void 0);T(Hh,new Gh(b.aft+(k||0)))}}}
function ai(a,b,c){if(Ve("debug_csi_data")){var d=r("yt.timing.csiData");d||(d=[],q("yt.timing.csiData",d,void 0));d.push({page:location.href,time:new Date,args:a})}var d="",e;for(e in a)d+="&"+e+"="+a[e];a="/csi_204?"+d.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b)try{window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,"")||a&&Pd(a)}catch(f){a&&Pd(a)}else a&&Pd(a);ci(!0,c)}
function Wh(){var a=$h().nonce;if(!a){var b;a:{if(window.crypto&&window.crypto.getRandomValues)try{var c=Array(16),d=new Uint8Array(16);window.crypto.getRandomValues(d);for(a=0;a<c.length;a++)c[a]=d[a];b=c;break a}catch(e){}b=Array(16);for(c=0;16>c;c++){d=x();for(a=0;a<d%23;a++)b[c]=Math.random();b[c]=Math.floor(256*Math.random())}if(Og)for(c=1,d=0;d<Og.length;d++)b[c%16]=b[c%16]^b[(c-1)%16]/4^Og.charCodeAt(d),c++}c=[];for(d=0;d<b.length;d++)c.push("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789-_".charAt(b[d]&
63));a=c.join("");$h().nonce=a}return a}
function Uh(){return $h().tick}
function Vh(){var a=$h();"gel"in a||(a.gel={});return a.gel}
function $h(){return r("ytcsi.data_")||bi()}
function bi(){var a={tick:{},info:{}};q("ytcsi.data_",a,void 0);return a}
function ci(a,b){q("yt.timing."+(b||"")+"pingSent_",a,void 0)}
function di(){var a=Uh(),b=a.pbr,c=a.vc,a=a.pbs;return b&&c&&a&&b<c&&c<a&&1==$h().info.yt_pvis}
;new Oh(ei,1E3);function ei(){Th("vptl",0);Th("vpl",0)}
;var fi={"api.invalidparam":2,auth:150,"drm.auth":150,"heartbeat.net":150,"heartbeat.servererror":150,"heartbeat.stop":150,"html5.unsupportedads":5,"fmt.noneavailable":5,"fmt.decode":5,"fmt.unplayable":5,"html5.missingapi":5,"html5.unsupportedlive":5,"drm.unavailable":5};function gi(a,b){D.call(this);this.D=this.w=a;this.Z=b;this.G=!1;this.g={};this.ga=this.Y=null;this.$=new M;ub(this,va(vb,this.$));this.j={};this.N=this.ha=this.i=this.pa=this.b=null;this.da=!1;this.O=this.J=this.W=this.X=null;this.ia={};this.hb=["onReady"];this.ea=new Ah(this);ub(this,va(vb,this.ea));this.na=null;this.Ca=NaN;this.fa={};hi(this);this.L("onDetailedError",w(this.Cb,this));this.L("onTabOrderChange",w(this.kb,this));this.L("onTabAnnounce",w(this.Da,this));this.L("WATCH_LATER_VIDEO_ADDED",
w(this.Db,this));this.L("WATCH_LATER_VIDEO_REMOVED",w(this.Eb,this));Vc||(this.L("onMouseWheelCapture",w(this.Ab,this)),this.L("onMouseWheelRelease",w(this.Bb,this)));this.L("onAdAnnounce",w(this.Da,this));this.T=new Ah(this);ub(this,va(vb,this.T));this.oa=!1;this.ma=null}
y(gi,D);var ii=["drm.unavailable","fmt.noneavailable","html5.missingapi","html5.unsupportedads","html5.unsupportedlive"];l=gi.prototype;l.ya=function(a,b){this.f||(ji(this,a),ki(this,b),this.G&&li(this))};
function ji(a,b){a.pa=b;a.b=Vg(b);a.i=a.b.attrs.id||a.i;"video-player"==a.i&&(a.i=a.Z,a.b.attrs.id=a.Z);a.D.id==a.i&&(a.i+="-player",a.b.attrs.id=a.i);a.b.args.enablejsapi="1";a.b.args.playerapiid=a.Z;a.ha||(a.ha=mi(a,a.b.args.jsapicallback||"onYouTubePlayerReady"));a.b.args.jsapicallback=null;var c=a.b.attrs.width;c&&(a.D.style.width=dh(Number(c)||c,!0));if(c=a.b.attrs.height)a.D.style.height=dh(Number(c)||c,!0)}
...
function ni(a){if(!p(a.b.disable.flash)){var b=a.b.disable,c;c=Xg(Wg.getInstance(),a.b.minVersion);b.flash=!c}return!a.b.disable.flash}
function oi(a,b){if((!b||(5!=(fi[b.errorCode]||5)?0:-1!=ii.indexOf(b.errorCode)))&&ni(a)){var c=pi(a);c&&c.stopVideo&&c.stopVideo();var d=a.b;c&&c.getUpdatedConfigurationData&&(c=c.getUpdatedConfigurationData(),d=Ug(c));d.args.autoplay=1;d.args.html5_unavailable="1";ji(a,d);ki(a,"flash")}}
function ki(a,b){if(!a.f){if(!b){var c;if(!(c=!a.b.html5&&ni(a))){if(!p(a.b.disable.html5)){var d;c=!0;void 0!=a.b.args.deviceHasDisplay&&(c=a.b.args.deviceHasDisplay);if(2.2==kh)d=!0;else{a:{var e=c;c=r("yt.player.utils.videoElement_");c||(c=document.createElement("VIDEO"),q("yt.player.utils.videoElement_",c,void 0));try{if(c.canPlayType)for(var e=e?yh:zh,f=0;f<e.length;f++)if(c.canPlayType(e[f])){d=null;break a}d="fmt.noneavailable"}catch(g){d="html5.missingapi"}}d=!d}d&&(d=qi(a)||a.b.assets.js);
a.b.disable.html5=!d;d||(a.b.args.html5_unavailable="1")}c=!!a.b.disable.html5}b=c?ni(a)?"flash":"unsupported":"html5"}("flash"==b?a.Ub:a.Vb).call(a)}}
function qi(a){var b=!0,c=pi(a);c&&a.b&&(a=a.b,b=C(c,"version")==a.assets.js);return b&&!!r("yt.player.Application.create")}
l.Vb=function(){if(!this.da){var a=qi(this);a&&"html5"==ri(this)?(this.N="html5",this.G||this.V()):(si(this),this.N="html5",a&&this.W?(this.w.appendChild(this.W),this.V()):(this.b.loaded=!0,this.X=w(function(){var a=this.w,c=Vg(this.b);r("yt.player.Application.create")(a,c);this.V()},this),this.da=!0,a?this.X():(ke(this.b.assets.js,this.X),se(this.b.assets.css))))}};
l.Ub=function(){var a=Vg(this.b);if(!this.J){var b=pi(this);b&&(this.J=document.createElement("SPAN"),this.J.tabIndex=0,Bh(this.ea,this.J,"focus",this.Ka),this.O=document.createElement("SPAN"),this.O.tabIndex=0,Bh(this.ea,this.O,"focus",this.Ka),b.parentNode&&b.parentNode.insertBefore(this.J,b),b.parentNode&&b.parentNode.insertBefore(this.O,b.nextSibling))}a.attrs.width=a.attrs.width||"100%";a.attrs.height=a.attrs.height||"100%";if("flash"==ri(this))this.N="flash",this.G||this.V();else{si(this);this.N=
"flash";this.b.loaded=!0;var b=Wg.getInstance(),c=(-1<b.i.indexOf("Gnash")&&-1==b.i.indexOf("AVM2")||9==b.b&&1==b.f||9==b.b&&0==b.f&&1==b.g?0:9<=b.b)||-1<navigator.userAgent.indexOf("Sony/COM2")&&!Xg(b,9,1,58)?a.url:a.urlV9As2;window!=window.top&&document.referrer&&(a.args.framer=document.referrer.substring(0,128));b=this.w;if(c){var b=v(b)?dd(b):b,d=Wa(a.attrs);d.tabindex=0;var e=Wa(a.params);e.flashvars=Vb(a.args);if(mb){d.classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000";e.movie=c;var a=document.createElement("object"),
...
l.Ka=function(){pi(this).focus()};
function pi(a){var b=dd(a.i);!b&&a.D&&a.D.querySelector&&(b=a.D.querySelector("#"+a.i));return b}
l.V=function(){if(!this.f){var a=pi(this),b=!1;try{a&&a.getApiInterface&&a.getApiInterface()&&(b=!0)}catch(f){}if(b)if(this.da=!1,a.isNotServable&&a.isNotServable(this.b.args.video_id))oi(this);else{hi(this);this.G=!0;a=pi(this);a.addEventListener&&(this.Y=ti(this,a,"addEventListener"));a.removeEventListener&&(this.ga=ti(this,a,"removeEventListener"));for(var b=a.getApiInterface(),b=b.concat(a.getInternalApiInterface()),c=0;c<b.length;c++){var d=b[c];this.g[d]||(this.g[d]=ti(this,a,d))}for(var e in this.j)this.Y(e,
this.j[e]);li(this);this.ha&&this.ha(this.g);this.$.M("onReady",this.g)}else this.Ca=B(w(this.V,this),50)}};
function ti(a,b,c){var d=b[c];return function(){try{return a.na=null,d.apply(b,arguments)}catch(e){"Bad NPObject as private data!"!=e.message&&"sendAbandonmentPing"!=c&&(e.message+=" ("+c+")",a.na=e,kb(e,"WARNING"))}}}
function hi(a){a.G=!1;if(a.ga)for(var b in a.j)a.ga(b,a.j[b]);for(var c in a.fa)jb(parseInt(c,10));a.fa={};a.Y=null;a.ga=null;for(var d in a.g)a.g[d]=null;a.g.addEventListener=w(a.L,a);a.g.removeEventListener=w(a.Mb,a);a.g.destroy=w(a.dispose,a);a.g.getLastError=w(a.rb,a);a.g.getPlayerType=w(a.sb,a);a.g.getCurrentVideoConfig=w(a.qb,a);a.g.loadNewVideoConfig=w(a.ya,a);a.g.isReady=w(a.Xb,a)}
l.Xb=function(){return this.G};
l.L=function(a,b){if(!this.f){var c=mi(this,b);if(c){if(!Eb(this.hb,a)&&!this.j[a]){var d=ui(this,a);this.Y&&this.Y(a,d)}this.$.subscribe(a,c);"onReady"==a&&this.G&&B(va(c,this.g),0)}}};
l.Mb=function(a,b){if(!this.f){var c=mi(this,b);c&&this.$.unsubscribe(a,c)}};
function mi(a,b){var c=b;if("string"==typeof b){if(a.ia[b])return a.ia[b];c=function(){var a=r(b);a&&a.apply(n,arguments)};
a.ia[b]=c}return c?c:null}
function ui(a,b){var c="ytPlayer"+b+a.Z;a.j[b]=c;n[c]=function(c){var d=B(function(){if(!a.f){a.$.M(b,c);var e=a.fa,g=String(d);g in e&&delete e[g]}},0);
Va(a.fa,String(d))};
return c}
l.kb=function(a){a=a?ld:kd;for(var b=a(document.activeElement);b&&(1!=b.nodeType||b==this.J||b==this.O||(b.focus(),b!=document.activeElement));)b=a(b)};
l.Da=function(a){Yd("a11y-announce",a)};
l.Cb=function(a){oi(this,a)};
l.Db=function(a){Yd("WATCH_LATER_VIDEO_ADDED",a)};
l.Eb=function(a){Yd("WATCH_LATER_VIDEO_REMOVED",a)};
l.Ab=function(){this.oa||(Zc?(this.ma=id(document),Bh(this.T,window,"scroll",this.Jb),Bh(this.T,this.w,"touchmove",this.Hb)):(Bh(this.T,this.w,"mousewheel",this.Na),Bh(this.T,this.w,"wheel",this.Na)),this.oa=!0)};
l.Bb=function(){Ch(this.T);this.oa=!1};
...
l.sb=function(){return this.N||ri(this)};
l.rb=function(){return this.na};
function ri(a){return(a=pi(a))?"div"==a.tagName.toLowerCase()?"html5":"flash":null}
function si(a){Th("dcp");a.cancel();hi(a);a.N=null;a.b&&(a.b.loaded=!1);var b=pi(a);"html5"==ri(a)?a.W=b:b&&b.destroy&&b.destroy();jd(a.w);Ch(a.ea);a.J=null;a.O=null}
l.cancel=function(){this.X&&re(this.b.assets.js,this.X);jb(this.Ca);this.da=!1};
l.A=function(){si(this);if(this.W&&this.b)try{this.W.destroy()}catch(b){kb(b)}this.ia=null;for(var a in this.j)n[this.j[a]]=null;this.pa=this.b=this.g=null;delete this.w;delete this.D;gi.B.A.call(this)};var vi={},wi="player_uid_"+(1E9*Math.random()>>>0);function xi(a,b){a=v(a)?dd(a):a;b=Ug(b);var c=wi+"_"+qa(a),d=vi[c];if(d)return d.ya(b),d.g;d=new gi(a,c);vi[c]=d;Yd("player-added",d.g);ub(d,va(yi,d));B(function(){d.ya(b)},0);
return d.g}
function yi(a){vi[a.Z]=null}
function zi(a){a=dd(a);if(!a)return null;var b=wi+"_"+qa(a),c=vi[b];c||(c=new gi(a,b),vi[b]=c);return c.g}
;var Ai=r("yt.abuse.botguardInitialized")||Ce;q("yt.abuse.botguardInitialized",Ai,void 0);var Bi=r("yt.abuse.invokeBotguard")||De;q("yt.abuse.invokeBotguard",Bi,void 0);var Ci=r("yt.abuse.dclkstatus.checkDclkStatus")||Ng;q("yt.abuse.dclkstatus.checkDclkStatus",Ci,void 0);var Di=r("yt.player.exports.navigate")||Pg;q("yt.player.exports.navigate",Di,void 0);var Ei=r("yt.player.embed")||xi;q("yt.player.embed",Ei,void 0);var Fi=r("yt.player.getPlayerByElement")||zi;q("yt.player.getPlayerByElement",Fi,void 0);
var Gi=r("yt.util.activity.init")||xg;q("yt.util.activity.init",Gi,void 0);var Hi=r("yt.util.activity.getTimeSinceActive")||zg;q("yt.util.activity.getTimeSinceActive",Hi,void 0);var Ii=r("yt.util.activity.setTimestamp")||yg;q("yt.util.activity.setTimestamp",Ii,void 0);function Ji(a){R.call(this,1,arguments);this.b=a}
y(Ji,R);function V(a){R.call(this,1,arguments);this.b=a}
y(V,R);function Ki(a,b,c){R.call(this,3,arguments);this.g=a;this.f=b;this.b=null!=c?!!c:null}
y(Ki,R);function Li(a,b,c,d,e){R.call(this,2,arguments);this.f=a;this.b=b;this.i=c||null;this.g=d||null;this.source=e||null}
y(Li,R);function Mi(a,b,c){R.call(this,1,arguments);this.b=a;this.subscriptionId=b}
y(Mi,R);function Ni(a,b,c,d,e,f,g){R.call(this,1,arguments);this.f=a;this.subscriptionId=b;this.b=c;this.j=d||null;this.i=e||null;this.g=f||null;this.source=g||null}
y(Ni,R);
var Oi=new S("subscription-batch-subscribe",Ji),Pi=new S("subscription-batch-unsubscribe",Ji),Qi=new S("subscription-subscribe",Li),Ri=new S("subscription-subscribe-loading",V),Si=new S("subscription-subscribe-loaded",V),Ti=new S("subscription-subscribe-success",Mi),Ui=new S("subscription-subscribe-external",Li),Vi=new S("subscription-unsubscribe",Ni),Wi=new S("subscription-unsubscirbe-loading",V),Xi=new S("subscription-unsubscribe-loaded",V),Yi=new S("subscription-unsubscribe-success",V),Zi=new S("subscription-external-unsubscribe",
Ni),$i=new S("subscription-enable-ypc",V),aj=new S("subscription-disable-ypc",V),bj=new S("subscription-prefs",Ki),cj=new S("subscription-prefs-success",Ki),dj=new S("subscription-prefs-failure",Ki);function ej(a,b){var c=document.location.protocol+"//"+document.domain+"/post_login";b&&(c=Wb(c,"mode",b));c=Wb("/signin?context=popup","next",c);c=Wb(c,"feature","sub_button");if(c=window.open(c,"loginPopup","width=375,height=440,resizable=yes,scrollbars=yes",!0)){var d=Vd("LOGGED_IN",function(b){Xd(A("LOGGED_IN_PUBSUB_KEY",void 0));z("LOGGED_IN",!0);a(b)});
z("LOGGED_IN_PUBSUB_KEY",d);c.moveTo((screen.width-375)/2,(screen.height-440)/2)}}
q("yt.pubsub.publish",Yd,void 0);function fj(){var a=A("PLAYER_CONFIG");return a&&a.args&&void 0!==a.args.authuser?!0:!(!A("SESSION_INDEX")&&!A("LOGGED_IN"))}
;function gj(){var a=Yf();return a?a:null}
;function hj(a,b){(a=dd(a))&&a.style&&(a.style.display=b?"":"none",of(a,"hid",!b))}
function ij(a){G(arguments,function(a){!na(a)||a instanceof Element?hj(a,!0):G(a,function(a){ij(a)})})}
function jj(a){G(arguments,function(a){!na(a)||a instanceof Element?hj(a,!1):G(a,function(a){jj(a)})})}
;var kj={},lj="ontouchstart"in document;function mj(a,b,c){var d;switch(a){case "mouseover":case "mouseout":d=3;break;case "mouseenter":case "mouseleave":d=9}return td(c,function(a){return lf(a,b)},!0,d)}
function W(a){var b="mouseover"==a.type&&"mouseenter"in kj||"mouseout"==a.type&&"mouseleave"in kj,c=a.type in kj||b;if("HTML"!=a.target.tagName&&c){if(b){var b="mouseover"==a.type?"mouseenter":"mouseleave",c=kj[b],d;for(d in c.H){var e=mj(b,d,a.target);e&&!td(a.relatedTarget,function(a){return a==e},!0)&&c.M(d,e,b,a)}}if(b=kj[a.type])for(d in b.H)(e=mj(a.type,d,a.target))&&b.M(d,e,a.type,a)}}
Q(document,"blur",W,!0);Q(document,"change",W,!0);Q(document,"click",W);Q(document,"focus",W,!0);Q(document,"mouseover",W);Q(document,"mouseout",W);Q(document,"mousedown",W);Q(document,"keydown",W);Q(document,"keyup",W);Q(document,"keypress",W);Q(document,"cut",W);Q(document,"paste",W);lj&&(Q(document,"touchstart",W),Q(document,"touchend",W),Q(document,"touchcancel",W));function nj(a){this.j=a;this.g={};this.ka=[];this.i=[]}
function X(a,b){return"yt-uix"+(a.j?"-"+a.j:"")+(b?"-"+b:"")}
nj.prototype.unregister=function(){Xd(this.ka);this.ka.length=0;Nh(this.i);this.i.length=0};
nj.prototype.init=t;nj.prototype.dispose=t;function oj(a,b,c){a.i.push(U(b,c,a))}
function pj(a,b,c){var d=X(a,void 0),e=w(c,a);b in kj||(kj[b]=new M);kj[b].subscribe(d,e);a.g[c]=e}
function qj(a,b,c){if(b in kj){var d=kj[b];d.unsubscribe(X(a,void 0),a.g[c]);0>=d.ba()&&(d.dispose(),delete kj[b])}delete a.g[c]}
function rj(a,b){nb(a,"tooltip-text",b)}
;function sj(){nj.call(this,"tooltip");this.b=0;this.f={}}
y(sj,nj);ka(sj);l=sj.prototype;l.register=function(){pj(this,"mouseover",this.ja);pj(this,"mouseout",this.R);pj(this,"focus",this.Ia);pj(this,"blur",this.Ga);pj(this,"click",this.R);pj(this,"touchstart",this.Va);pj(this,"touchend",this.la);pj(this,"touchcancel",this.la)};
l.unregister=function(){qj(this,"mouseover",this.ja);qj(this,"mouseout",this.R);qj(this,"focus",this.Ia);qj(this,"blur",this.Ga);qj(this,"click",this.R);qj(this,"touchstart",this.Va);qj(this,"touchend",this.la);qj(this,"touchcancel",this.la);this.dispose();sj.B.unregister.call(this)};
l.dispose=function(){for(var a in this.f)this.R(this.f[a]);this.f={}};
l.ja=function(a){if(!(this.b&&1E3>x()-this.b)){var b=parseInt(C(a,"tooltip-hide-timer"),10);b&&(qb(a,"tooltip-hide-timer"),jb(b));var b=w(function(){tj(this,a);qb(a,"tooltip-show-timer")},this),c=parseInt(C(a,"tooltip-show-delay"),10)||0,b=B(b,c);
nb(a,"tooltip-show-timer",b.toString());a.title&&(rj(a,uj(a)),a.title="");b=qa(a).toString();this.f[b]=a}};
l.R=function(a){var b=parseInt(C(a,"tooltip-show-timer"),10);b&&(jb(b),qb(a,"tooltip-show-timer"));b=w(function(){if(a){var b=dd(vj(this,a));b&&(wj(b),b&&b.parentNode&&b.parentNode.removeChild(b),qb(a,"content-id"));(b=dd(vj(this,a,"arialabel")))&&b.parentNode&&b.parentNode.removeChild(b)}qb(a,"tooltip-hide-timer")},this);
...
l.Va=function(a,b,c){c.changedTouches&&(this.b=0,a=mj(b,X(this),c.changedTouches[0].target),this.ja(a))};
l.la=function(a,b,c){c.changedTouches&&(this.b=x(),a=mj(b,X(this),c.changedTouches[0].target),this.R(a))};
function xj(a,b){rj(a,b);var c=C(a,"content-id");(c=dd(c))&&md(c,b)}
function uj(a){return C(a,"tooltip-text")||a.title}
function tj(a,b){if(b){var c=uj(b);if(c){var d=dd(vj(a,b));if(!d){d=document.createElement("div");d.id=vj(a,b);d.className=X(a,"tip");var e=document.createElement("div");e.className=X(a,"tip-body");var f=document.createElement("div");f.className=X(a,"tip-arrow");var g=document.createElement("div");g.setAttribute("aria-hidden","true");g.className=X(a,"tip-content");var k=yj(a,b),h=vj(a,b,"content");g.id=h;nb(b,"content-id",h);e.appendChild(g);k&&d.appendChild(k);d.appendChild(e);d.appendChild(f);var m=
pd(b),h=vj(a,b,"arialabel"),f=document.createElement("div");mf(f,X(a,"arialabel"));f.id=h;m=b.hasAttribute("aria-label")?b.getAttribute("aria-label"):"rtl"==document.body.getAttribute("dir")?c+" "+m:m+" "+c;md(f,m);b.setAttribute("aria-labelledby",h);h=gj()||document.body;h.appendChild(f);h.appendChild(d);xj(b,c);(c=parseInt(C(b,"tooltip-max-width"),10))&&e.offsetWidth>c&&(e.style.width=c+"px",mf(g,X(a,"normal-wrap")));g=lf(b,X(a,"reverse"));zj(a,b,d,e,k,g)||zj(a,b,d,e,k,!g);var u=X(a,"tip-visible");
B(function(){mf(d,u)},0)}}}}
...
function vj(a,b,c){a=X(a);var d=b.__yt_uid_key;d||(d=Wf(),b.__yt_uid_key=d);b=a+d;c&&(b+="-"+c);return b}
function yj(a,b){var c=null;xc&&lf(b,X(a,"masked"))&&((c=dd("yt-uix-tooltip-shared-mask"))?(c.parentNode.removeChild(c),ij(c)):(c=document.createElement("iframe"),c.src='javascript:""',c.id="yt-uix-tooltip-shared-mask",c.className=X(a,"tip-mask")));return c}
function wj(a){var b=dd("yt-uix-tooltip-shared-mask"),c=b&&td(b,function(b){return b==a},!1,2);
b&&c&&(b.parentNode.removeChild(b),jj(b),document.body.appendChild(b))}
;function Aj(){nj.call(this,"subscription-button")}
y(Aj,nj);ka(Aj);Aj.prototype.register=function(){pj(this,"click",this.ra);oj(this,Ri,this.Ma);oj(this,Si,this.La);oj(this,Ti,this.Gb);oj(this,Wi,this.Ma);oj(this,Xi,this.La);oj(this,Yi,this.Ib);oj(this,$i,this.zb);oj(this,aj,this.yb)};
Aj.prototype.unregister=function(){qj(this,"click",this.ra);Aj.B.unregister.call(this)};
var sd={za:"hover-enabled",Za:"yt-uix-button-subscribe",$a:"yt-uix-button-subscribed",Yb:"ypc-enabled",ab:"yt-uix-button-subscription-container",bb:"yt-subscription-button-disabled-mask-container"},Bj={Zb:"channel-external-id",cb:"subscriber-count-show-when-subscribed",eb:"subscriber-count-tooltip",fb:"subscriber-count-title",$b:"href",ac:"insecure",Aa:"is-subscribed",cc:"parent-url",dc:"clicktracking",gb:"style-type",Ba:"subscription-id",ec:"target",ib:"ypc-enabled"};l=Aj.prototype;
l.ra=function(a){var b=C(a,"href"),c=C(a,"insecure"),d=fj(),c=c&&!0;if(b)a=C(a,"target")||"_self",window.open(b,a);else if(!c)if(d){b=C(a,"channel-external-id");d=C(a,"clicktracking");if(C(a,"ypc-enabled"))var c=C(a,"ypc-item-type"),e=C(a,"ypc-item-id"),c={itemType:c,itemId:e,subscriptionElement:a};else c=null;e=C(a,"parent-url");if(C(a,"is-subscribed")){var f=C(a,"subscription-id");T(Vi,new Ni(b,f,c,a,d,e))}else T(Qi,new Li(b,c,d,e))}else Cj(this,a)};
...
l.Ua=function(a,b,c){b?(nb(a,Bj.Aa,"true"),c&&nb(a,Bj.Ba,c)):(qb(a,Bj.Aa),qb(a,Bj.Ba));Dj(a)};
l.Ta=function(a,b){var c;c=rd(a);of(c,sd.bb,b);a.setAttribute("aria-busy",b?"true":"false");a.disabled=b};
function Dj(a){var b=C(a,Bj.gb),c=!!C(a,"is-subscribed"),b="-"+b,d=sd.$a+b;of(a,sd.Za+b,!c);of(a,d,c);C(a,Bj.eb)&&!C(a,Bj.cb)&&(b=X(sj.getInstance()),of(a,b,!c),a.title=c?"":C(a,Bj.fb));c?B(function(){mf(a,sd.za)},1E3):nf(a,sd.za)}
l.ob=function(a){var b=!!C(a,"ypc-item-type"),c=!!C(a,"ypc-item-id");!C(a,"ypc-enabled")&&b&&c&&(mf(a,"ypc-enabled"),nb(a,Bj.ib,"true"))};
l.mb=function(a){C(a,"ypc-enabled")&&(nf(a,"ypc-enabled"),qb(a,"ypc-enabled"))};
function Ej(a,b){return Ab(ed(X(a)),function(a){return b==C(a,"channel-external-id")},a)}
l.jb=function(a,b,c){var d=Kb(arguments,2);G(a,function(a){b.apply(this,Gb(a,d))},this)};
l.U=function(a,b,c){var d=Ej(this,a);this.jb.apply(this,Gb([d],Kb(arguments,1)))};
function Cj(a,b){var c=w(function(a){a.discoverable_subscriptions&&z("SUBSCRIBE_EMBED_DISCOVERABLE_SUBSCRIPTIONS",a.discoverable_subscriptions);this.ra(b)},a);
ej(c,"subscribe")}
;var Fj=window.yt&&window.yt.uix&&window.yt.uix.widgets_||{};q("yt.uix.widgets_",Fj,void 0);function Gj(a){return(0==a.search("cue")||0==a.search("load"))&&"loadModule"!=a}
function Hj(a,b,c){v(a)&&(a={mediaContentUrl:a,startSeconds:b,suggestedQuality:c});b=/\/([ve]|embed)\/([^#?]+)/.exec(a.mediaContentUrl);a.videoId=b&&b[2]?b[2]:null;return Ij(a)}
function Ij(a,b,c){if(pa(a)){b="endSeconds startSeconds mediaContentUrl suggestedQuality videoId two_stage_token".split(" ");c={};for(var d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}return{videoId:a,startSeconds:b,suggestedQuality:c}}
function Jj(a,b,c,d){if(pa(a)&&!ma(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}c={index:b,startSeconds:c,suggestedQuality:d};v(a)&&16==a.length?c.list="PL"+a:c.playlist=a;return c}
function Kj(a){var b=a.video_id||a.videoId;if(v(b)){var c=mg()||{},d=mg()||{};p(void 0)?d[b]=void 0:delete d[b];var e=x()+3E5,f=og;if(f&&window.JSON){v(d)||(d=JSON.stringify(d,void 0));try{f.set("yt-player-two-stage-token",d,e)}catch(g){f.remove("yt-player-two-stage-token")}}(b=c[b])&&(a.two_stage_token=b)}}
;var Lj=null,Mj=[];function Nj(a){return{externalChannelId:a.externalChannelId,xb:!!a.isChannelPaid,source:a.source,subscriptionId:a.subscriptionId}}
function Oj(a){Pj(Nj(a))}
function Pj(a){fj()?(T(Qi,new Li(a.externalChannelId,a.xb?{itemType:"U",itemId:a.externalChannelId}:null)),(a="/gen_204?"+Vb({event:"subscribe",source:a.source}))&&Pd(a)):Qj(a)}
function Qj(a){ej(function(b){b.subscription_ajax&&Pj(a)},null)}
function Rj(a){a=Nj(a);T(Vi,new Ni(a.externalChannelId,a.subscriptionId,null));(a="/gen_204?"+Vb({event:"unsubscribe",source:a.source}))&&Pd(a)}
function Sj(a){Lj&&Lj.channelSubscribed(a.b,a.subscriptionId)}
function Tj(a){Lj&&Lj.channelUnsubscribed(a.b)}
;function Uj(a){D.call(this);this.g=a;this.g.subscribe("command",this.Qa,this);this.i={};this.j=!1}
y(Uj,D);l=Uj.prototype;l.start=function(){this.j||this.f||(this.j=!0,Vj(this.g,"RECEIVING"))};
l.Qa=function(a,b){if(this.j&&!this.f){var c=b||{};switch(a){case "addEventListener":if(v(c.event)&&(c=c.event,!(c in this.i))){var d=w(this.Ob,this,c);this.i[c]=d;this.addEventListener(c,d)}break;case "removeEventListener":v(c.event)&&Wj(this,c.event);break;default:this.b.isReady()&&this.b[a]&&(c=Xj(a,b||{}),c=this.b[a].apply(this.b,c),(c=Yj(a,c))&&this.j&&!this.f&&Vj(this.g,a,c))}}};
l.Ob=function(a,b){this.j&&!this.f&&Vj(this.g,a,this.sa(a,b))};
l.sa=function(a,b){if(null!=b)return{value:b}};
function Wj(a,b){b in a.i&&(a.removeEventListener(b,a.i[b]),delete a.i[b])}
l.A=function(){this.g.unsubscribe("command",this.Qa,this);this.g=null;for(var a in this.i)Wj(this,a);Uj.B.A.call(this)};function Zj(a,b,c,d){D.call(this);this.i=b||null;this.J="*";this.j=c||null;this.b=null;this.channel=d||null;this.N=!!a;this.G=w(this.O,this);window.addEventListener("message",this.G)}
y(Zj,D);Zj.prototype.O=function(a){if(!("*"!=this.j&&a.origin!=this.j||this.i&&a.source!=this.i)&&v(a.data)){var b;try{b=Ea(a.data)}catch(c){return}if(!(null==b||this.N&&(this.b&&this.b!=b.id||this.channel&&this.channel!=b.channel))&&b)switch(b.event){case "listening":"null"!=a.origin?this.j=this.J=a.origin:kb(Error("MessageEvent origin is null"),"WARNING");this.i=a.source;this.b=b.id;this.g&&(this.g(),this.g=null);break;case "command":this.w&&(this.D&&!Eb(this.D,b.func)||this.w(b.func,b.args))}}};
Zj.prototype.sendMessage=function(a,b){var c=b||this.i;if(c){this.b&&(a.id=this.b);this.channel&&(a.channel=this.channel);try{var d=Ga(a);c.postMessage(d,this.J)}catch(e){kb(e,"WARNING")}}};
Zj.prototype.A=function(){window.removeEventListener("message",this.G);Zj.B.A.call(this)};function ak(a,b,c){Zj.call(this,a,b,c||A("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname,"widget");this.D=this.g=this.w=null}
y(ak,Zj);new M;function bk(a,b,c){Yg.call(this);this.g=a;this.i=b;this.j=c}
y(bk,Yg);function Vj(a,b,c){if(!a.f){var d=a.g;d.f||a.i!=d.b||(a={id:a.j,command:b},c&&(a.data=c),d.b.postMessage(Ga(a),d.i))}}
bk.prototype.A=function(){this.i=this.g=null;bk.B.A.call(this)};function ck(){var a=this.f=new ak(!!A("WIDGET_ID_ENFORCE")),b=w(this.Lb,this);a.w=b;a.D=null;this.f.channel="widget";if(a=A("WIDGET_ID"))this.f.b=a;this.i=[];this.w=!1;this.j={}}
...
l.pb=function(){this.w=!0;this.sendMessage("initialDelivery",this.ta());this.sendMessage("onReady");G(this.i,this.Sa,this);this.i=[]};
...
l.dispose=function(){this.f=null};function fk(a,b,c){D.call(this);this.b=a;this.i=c;this.j=Q(window,"message",w(this.w,this));this.g=new bk(this,a,b);ub(this,va(vb,this.g))}
y(fk,D);fk.prototype.w=function(a){var b;if(b=!this.f)if(b=a.origin==this.i)a:{b=this.b;do{var c;b:{c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(a=a.data,v(a))){try{a=Ea(a)}catch(d){return}a.command&&(b=this.g,b.f||b.M("command",a.command,a.data))}};
fk.prototype.A=function(){eg(this.j);this.b=null;fk.B.A.call(this)};function gk(a,b){Uj.call(this,b);this.b=a;this.start()}
y(gk,Uj);gk.prototype.addEventListener=function(a,b){this.b.addEventListener(a,b)};
gk.prototype.removeEventListener=function(a,b){this.b.removeEventListener(a,b)};
function Xj(a,b){switch(a){case "loadVideoById":return b=Ij(b),Kj(b),[b];case "cueVideoById":return b=Ij(b),Kj(b),[b];case "loadVideoByPlayerVars":return Kj(b),[b];case "cueVideoByPlayerVars":return Kj(b),[b];case "loadPlaylist":return b=Jj(b),Kj(b),[b];case "cuePlaylist":return b=Jj(b),Kj(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];
...
gk.prototype.A=function(){gk.B.A.call(this);delete this.b};function hk(a){ck.call(this);this.b=a;this.g=[];this.addEventListener("onReady",w(this.Fb,this));this.addEventListener("onVideoProgress",w(this.Sb,this));this.addEventListener("onVolumeChange",w(this.Tb,this));this.addEventListener("onApiChange",w(this.Nb,this));this.addEventListener("onPlaybackQualityChange",w(this.Pb,this));this.addEventListener("onPlaybackRateChange",w(this.Qb,this));this.addEventListener("onStateChange",w(this.Rb,this))}
y(hk,ck);l=hk.prototype;l.Xa=function(a,b){if(this.b[a]){b=b||[];if(0<b.length&&Gj(a)){var c;c=b;if(pa(c[0])&&!ma(c[0]))c=c[0];else{var d={};switch(a){case "loadVideoById":case "cueVideoById":d=Ij.apply(window,c);break;case "loadVideoByUrl":case "cueVideoByUrl":d=Hj.apply(window,c);break;case "loadPlaylist":case "cuePlaylist":d=Jj.apply(window,c)}c=d}Kj(c);b.length=1;b[0]=c}this.b[a].apply(this.b,b);Gj(a)&&ek(this,this.ta())}};
...
y(Jk,R);var Kk=new S("ypc-core-load",Fk),Lk=new S("ypc-guide-sync-success",Gk),Mk=new S("ypc-purchase-success",Hk),Nk=new S("ypc-subscription-cancel",Jk),Ok=new S("ypc-subscription-cancel-success",Ik),Pk=new S("ypc-init-subscription",Jk);var Qk=!1,Rk=[],Sk=[];function Tk(a){a.b?Qk?T(Ui,a):T(Kk,new Fk(function(){T(Pk,new Jk(a.b))})):Uk(a.f,a.i,a.g,a.source)}
function Vk(a){a.b?Qk?T(Zi,a):T(Kk,new Fk(function(){T(Nk,new Jk(a.b))})):Wk(a.f,a.subscriptionId,a.i,a.g,a.source)}
function Xk(a){Yk(Hb(a.b))}
function Zk(a){$k(Hb(a.b))}
function al(a){bl(a.g,a.f,a.b)}
function cl(a){var b=a.itemId,c=a.b.subscriptionId;b&&c&&T(Ti,new Mi(b,c,a.b.channelInfo))}
function dl(a){var b=a.b;Qa(a.f,function(a,d){T(Ti,new Mi(d,a,b[d]))})}
function el(a){T(Yi,new V(a.f.itemId));a.b&&a.b.length&&(fl(a.b,Yi),fl(a.b,$i))}
function Uk(a,b,c,d){var e=new V(a);T(Ri,e);var f={};f.c=a;c&&(f.eurl=c);d&&(f.source=d);c={};(d=A("PLAYBACK_ID"))&&(c.plid=d);(d=A("EVENT_ID"))&&(c.ei=d);b&&gl(b,c);ee("/subscription_ajax?action_create_subscription_to_channel=1",{method:"POST",xa:f,C:c,F:function(b,c){var d=c.response;T(Ti,new Mi(a,d.id,d.channel_info));d.show_feed_privacy_dialog&&Yd("SHOW-FEED-PRIVACY-SUBSCRIBE-DIALOG",a);d.actions&&Ek(d.actions)},
wa:function(){T(Si,e)}})}
function Wk(a,b,c,d,e){var f=new V(a);T(Wi,f);var g={};d&&(g.eurl=d);e&&(g.source=e);d={};d.c=a;d.s=b;(a=A("PLAYBACK_ID"))&&(d.plid=a);(a=A("EVENT_ID"))&&(d.ei=a);c&&gl(c,d);ee("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",xa:g,C:d,F:function(a,b){var c=b.response;T(Yi,f);c.actions&&Ek(c.actions)},
wa:function(){T(Xi,f)}})}
function bl(a,b,c){if(a){var d={};d.channel_id=a;switch(b){case "receive-all-updates":d.receive_all_updates=!0;break;case "receive-no-updates":d.receive_no_updates=!0;d.receive_post_updates=!1;break;case "receive-highlight-updates":d.receive_all_updates=!1;d.receive_no_updates=!1;break;default:return}null===c||d.receive_no_updates||(d.receive_post_updates=c);var e=new Ki(a,b,c);ee("/subscription_ajax?action_update_subscription_preferences=1",{method:"POST",C:d,onError:function(){T(dj,e)},
F:function(){T(cj,e)}})}}
function Yk(a){if(a.length){var b=Jb(a,0,40);T("subscription-batch-subscribe-loading");fl(b,Ri);var c={};c.a=b.join(",");var d=function(){T("subscription-batch-subscribe-loaded");fl(b,Si)};
ee("/subscription_ajax?action_create_subscription_to_all=1",{method:"POST",C:c,F:function(c,f){d();var e=f.response,k=e.id;if(ma(k)&&k.length==b.length){var h=e.channel_info_map;G(k,function(a,c){var d=b[c];T(Ti,new Mi(d,a,h[d]))});
a.length?Yk(a):T("subscription-batch-subscribe-finished")}},
onError:function(){d();T("subscription-batch-subscribe-failure")}})}}
function $k(a){if(a.length){var b=Jb(a,0,40);T("subscription-batch-unsubscribe-loading");fl(b,Wi);var c={};c.c=b.join(",");var d=function(){T("subscription-batch-unsubscribe-loaded");fl(b,Xi)};
ee("/subscription_ajax?action_remove_subscriptions=1",{method:"POST",C:c,F:function(){d();fl(b,Yi);a.length&&$k(a)},
onError:function(){d()}})}}
...
q("writeEmbed",function(){var a=A("PLAYER_CONFIG",void 0);"1"!=a.privembed&&yk();"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");var b=document.referrer,c=A("POST_MESSAGE_ORIGIN");window!=window.top&&b&&b!=document.URL&&(a.args.loaderUrl=b);A("LIGHTWEIGHT_AUTOPLAY")&&(a.args.autoplay="1");a.args.autoplay&&Kj(a.args);hl=b=xi("player",a);b.addEventListener("onScreenChanged",ml);b.addEventListener("onLogClientVeCreated",ll);b.addEventListener("onLogServerVeCreated",nl);b.addEventListener("onLogVeClicked",
ol);b.addEventListener("onLogVesShown",pl);b.addEventListener("onReady",ql);var d=A("POST_MESSAGE_ID","player");A("ENABLE_JS_API")?jl=new hk(b):A("ENABLE_POST_API")&&v(d)&&v(c)&&(il=new fk(window.parent,d,c),jl=new gk(b,il.g));A("ENABLE_CAST_API")||(a.args.enablecastapi="0");A("BG_P")&&(A("BG_I")||A("BG_IU"))&&Be();Mg();Lj=b;Lj.addEventListener("SUBSCRIBE",Oj);Lj.addEventListener("UNSUBSCRIBE",Rj);Mj.push(U(Ti,Sj),U(Yi,Tj))},void 0);
q("yt.www.watch.ads.restrictioncookie.spr",function(a){(a+="mac_204?action_fcts=1")&&Pd(a);return!0},void 0);
var rl=ib(function(){Th("ol");Qk=!0;Sk.push(U(Qi,Tk),U(Vi,Vk));Qk||Sk.push(U(Ui,Tk),U(Zi,Vk),U(Oi,Xk),U(Pi,Zk),U(bj,al),U(Mk,cl),U(Ok,el),U(Lk,dl));var a=Ak.getInstance(),b=1<window.devicePixelRatio;if(!!((Dk("f"+(Math.floor(119/31)+1))||0)&67108864)!=b){var c="f"+(Math.floor(119/31)+1),d=Dk(c)||0,d=b?d|67108864:d&-67108865;0==d?delete Z[c]:Z[c]=d.toString(16).toString();var a=a.b,b=[],e;for(e in Z)b.push(e+"="+escape(Z[e]));Pa.set(""+a,b.join("&"),63072E3,"/","youtube.com")}}),sl=ib(function(){var a=
hl;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();A("PL_ATT")&&(Ae=null);for(var a=0,b=Kg.length;a<b;a++){var c=Kg[a];if(!isNaN(c)){var d=r("yt.scheduler.instance.cancelJob");d?d(c):jb(c)}}Kg.length=0;a=oe("//static.doubleclick.net/instream/ad_status.js");if(b=document.getElementById(a))$d(a),b.parentNode.removeChild(b);Lg=!1;z("DCLKSTAT",0);Xd(Rk);Rk.length=0;Nh(Sk);Sk.length=0;Qk=!1;Lj&&(Lj.removeEventListener("SUBSCRIBE",Pj),Lj.removeEventListener("UNSUBSCRIBE",Rj));Lj=null;Nh(Mj);Mj.length=0;
...
window.addEventListener?(window.addEventListener("load",rl),window.addEventListener("unload",sl)):window.attachEvent&&(window.attachEvent("onload",rl),window.attachEvent("onunload",sl));var tl=Aj.getInstance(),ul=X(tl);ul in Fj||(tl.register(),tl.ka.push(Vd("yt-uix-init-"+ul,tl.init,tl)),tl.ka.push(Vd("yt-uix-dispose-"+ul,tl.dispose,tl)),Fj[ul]=tl);}).call(this);
