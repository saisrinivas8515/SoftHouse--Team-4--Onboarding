...
<div class="login">
    ...
    <div><button type="submit" class="btn btn-xs btn-info"> Login </button></div>
</div>
...
<!--<section id="content">
     <div class="row">
         ...
         &lt;!&ndash;<div ng-show="error" class="alert alert-danger">{{error}}</div>&ndash;&gt;
